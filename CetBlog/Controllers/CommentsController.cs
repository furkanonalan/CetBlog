...
namespace CetBlog.Controllers
{
    public class CommentsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Comments.Include(c => c.ParentComment).Include(c => c.Post);
        ...
        public async Task<IActionResult> Create([Bind("Id,UserFullName,Content,CreateDate,PostId,ParentCommentId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserFullName,Content,CreateDate,PostId,ParentCommentId")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
